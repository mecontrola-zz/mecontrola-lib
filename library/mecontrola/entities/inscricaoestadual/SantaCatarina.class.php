...
/**
 * Classe utilizada para fazer a formatação e validação dos dados de inscrição estadual do estado de Santa Catarina.
 *
 * @author Rafael Almeida de Oliveira <mecontrola@gmail.com>
 * @namespace mecontrola\entities\inscricaoestadual
 * @since 1.0.20150518
 * @link http://www.sintegra.gov.br/Cad_Estados/cad_SC.html
 * @link http://sistemas3.sef.sc.gov.br/sintegra/consulta_empresa_pesquisa.aspx
 */
class SantaCatarina extends Formatter implements Validator
{
	protected $pattern = '/^[0-9]{3}(\.[0-9]{3}){2}$/';
	
	/**
	 * Faz a validação da inscrição estadual informada utilizando a rotina de validação do estado de Santa Catarina.
	 *
	 * @access public
	...
	/**
	 * Retorna a máscara de formatação da inscrição estadual do estado de Santa Catarina.
	 *
	 * @access public
	...
	/**
	 * Gera um número de inscrição estadual do Santa Catarina formatado ou não. Por padrão <code>$formatar</code> está definido como <code>TRUE</code>.
	 * 
	 * @access public
