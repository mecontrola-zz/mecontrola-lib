...
/**
 * Classe utilizada para fazer a formatação e validação dos dados de inscrição estadual do estado do Rio de Janeiro.
 *
 * @author Rafael Almeida de Oliveira <mecontrola@gmail.com>
 * @namespace mecontrola\entities\inscricaoestadual
 * @since 1.0.20150518
 * @link http://www.sintegra.gov.br/Cad_Estados/cad_RJ.html
 * @link http://www.fazenda.rj.gov.br/projetoCPS/consulta.jsp
 */
class RioDeJaneiro extends Formatter implements Validator
{
	protected $pattern = '/^[0-9]{2}(\.[0-9]{3}){2}$/';
	
	/**
	 * Faz a validação da inscrição estadual informada utilizando a rotina de validação do estado do Rio de Janeiro.
	 *
	 * @access public
	...
	/**
	 * Retorna a máscara de formatação da inscrição estadual do estado do Rio de Janeiro.
	 *
	 * @access public
	...
	/**
	 * Gera um número de inscrição estadual do Rio de Janeiro formatado ou não. Por padrão <code>$formatar</code> está definido como <code>TRUE</code>.
	 * 
	 * @access public
