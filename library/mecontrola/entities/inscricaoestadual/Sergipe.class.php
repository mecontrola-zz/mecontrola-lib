...
/**
 * Classe utilizada para fazer a formatação e validação dos dados de inscrição estadual do estado de Sergipe.
 *
 * @author Rafael Almeida de Oliveira <mecontrola@gmail.com>
 * @namespace mecontrola\entities\inscricaoestadual
 * @since 1.0.20150518
 * @link http://www.sintegra.gov.br/Cad_Estados/cad_SE.html
 * @link https://security.sefaz.se.gov.br/SIC/sintegra/index.jsp
 */
class Sergipe extends Formatter implements Validator
{
	protected $pattern = '/^[0-9]{2}(\.[0-9]{3}){2}-[0-9]$/';
	
	/**
	 * Faz a validação da inscrição estadual informada utilizando a rotina de validação do estado de Sergipe.
	 *
	 * @access public
	...
	/**
	 * Retorna a máscara de formatação da inscrição estadual do estado de Sergipe.
	 *
	 * @access public
	...
	/**
	 * Gera um número de inscrição estadual do Sergipe formatado ou não. Por padrão <code>$formatar</code> está definido como <code>TRUE</code>.
	 * 
	 * @access public
