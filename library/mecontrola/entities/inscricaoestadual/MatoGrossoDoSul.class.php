 ...
 * @namespace mecontrola\entities\inscricaoestadual
 * @since 1.0.20150518
 * @link http://www.sintegra.gov.br/Cad_Estados/cad_MS.html
 * @link https://servicos.efazenda.ms.gov.br/consultacci
 * @link http://www.jusbrasil.com.br/diarios/35605980/doems-26-03-2012-pg-7
 */
class MatoGrossoDoSul extends Formatter implements Validator
{
	protected $pattern = '/^28(\.[0-9]{3}){2}-[0-9]$/';
	
	/**
	 * Faz a validação da inscrição estadual informada utilizando a rotina de validação do estado do Mato Grosso do Sul.
	 *
	 * @access public
	...
	/**
	 * Retorna a máscara de formatação da inscrição estadual do estado do Mato Grosso do Sul.
	 *
	 * @access public
	...
	/**
	 * Gera um número de inscrição estadual do Mato Grosso do Sul formatado ou não. Por padrão <code>$formatar</code> está definido como <code>TRUE</code>.
	 * 
	 * @access public
