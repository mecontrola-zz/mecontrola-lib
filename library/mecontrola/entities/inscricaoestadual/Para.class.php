...
/**
 * Classe utilizada para fazer a formatação e validação dos dados de inscrição estadual do estado do Pará.
 * 
 * @author Rafael Almeida de Oliveira <mecontrola@gmail.com>
 * @namespace mecontrola\entities\inscricaoestadual
 * @since 1.0.20150518
 * @link http://www.sintegra.gov.br/Cad_Estados/cad_PA.html
 * @link https://app.sefa.pa.gov.br/Sintegra/
 * @link http://www.jusbrasil.com.br/diarios/75826494/doepa-caderno-2-01-09-2014-pg-1
 */
class Para extends Formatter implements Validator
{
	protected $pattern = '/^15(\.[0-9]{3}){2}-[0-9]$/';
	
	/**
	 * Faz a validação da inscrição estadual informada utilizando a rotina de validação do estado do Pará.
	 * 
	 * @access public
	...
	/**
	 * Retorna a máscara de formatação da inscrição estadual do estado do Pará.
	 * 
	 * @access public
	...
	/**
	 * Gera um número de inscrição estadual do Pará formatado ou não. Por padrão <code>$formatar</code> está definido como <code>TRUE</code>.
	 * 
	 * @access public
